...
az keyvault create --name "kartikeshnkv" --resource-group "kartikeshn-tfstate" --location uksouth
az keyvault secret set --vault-name "kartikeshnkv" --name "tfstateaccess" --value $env:ACCOUNT_KEY
az keyvault secret show --vault-name "kartikeshnkv" --name "tfstateaccess"
